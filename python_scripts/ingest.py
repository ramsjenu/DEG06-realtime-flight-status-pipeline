...
value_schema = avro.load('/Users/vrams/Master/82-Hands-on/04-Data-Engineering/free-real-time-flight-pipeline/python_scripts/flights-value.avsc')
# Update with your schema file path
key_schema = avro.load('/Users/vrams/Master/82-Hands-on/04-Data-Engineering/free-real-time-flight-pipeline/python_scripts/key_schema.avsc')
  # Update with your schema file path


# Create an AvroProducer
producer = AvroProducer(producer_config, default_key_schema=avro.load('/Users/vrams/Master/82-Hands-on/04-Data-Engineering/free-real-time-flight-pipeline/python_scripts/key_schema.avsc'), default_value_schema=value_schema)
